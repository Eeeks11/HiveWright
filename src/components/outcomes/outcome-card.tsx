...
const STATUS_CLASSES: Record<OwnerOutcomeSummary["status"], string> = {
  unread: "bg-amber-100 text-amber-900 dark:bg-amber-950 dark:text-amber-200",
  reviewed: "bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-200",
  accepted: "bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-200",
  changes_requested: "bg-red-100 text-red-800 dark:bg-red-950 dark:text-red-200",
